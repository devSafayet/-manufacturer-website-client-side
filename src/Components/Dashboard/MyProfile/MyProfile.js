...
const MyProfile = () => {
    ...
    return (
        <div className='flex justify-center items-center bg-slate-200 rounded-box'>
            <div className=''>
                <form onSubmit={handleSubmit(onSubmit)} className='py-10 bg-white my-10 p-10'>
                    <p className="text-3xl text-warning text-center"><span className='text-blue-400'>{user.displayName}</span> Details</p>
