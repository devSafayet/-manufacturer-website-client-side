...
const Signup = () => {
    ...
    return (
        <div className='flex h-screen justify-center items-center p-20  bg-base-200'>
                ...
                <div className="card-body">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="flex flex-col w-full border-opacity-50 mt-3">
                            <input type="submit" value="SignUp" className="grid btn bg-blue-400 rounded-box place-items-center input input-bordered w-full max-w-xs" />

                            <p className='m-3'>Already have an account?
                                <span><Link to="/singin" className='text-primary text-xxl cursor-pointer'>SingIn</Link></span></p>
